...
<head>
    ...
    <!--====== Bootstrap css ======-->
    <link rel="stylesheet" href="<?=base_url('./assets/layout9/css/bootstrap.min.css');?>">
    
    <!--====== Animate css ======-->
    <link rel="stylesheet" href="<?=base_url('./assets/layout9/css/animate.css');?>">
    
    <!--====== Magnific Popup css ======-->
    <link rel="stylesheet" href="<?=base_url('./assets/layout9/css/magnific-popup.css');?>">
    
    <!--====== Slick css ======-->
    <link rel="stylesheet" href="<?=base_url('./assets/layout9/css/slick.css');?>">
    
    <!--====== Line Icons css ======-->
    <link rel="stylesheet" href="<?=base_url('./assets/layout9/css/LineIcons.css');?>">
    
    <!--====== Default css ======-->
    <link rel="stylesheet" href="<?=base_url('./assets/layout9/css/default.css');?>">
    
    <!--====== Style css ======-->
    <link rel="stylesheet" href="<?=base_url('./assets/layout9/css/style.css');?>">
    
    <!--====== Responsive css ======-->
    <link rel="stylesheet" href="<?=base_url('./assets/layout9/css/responsive.css');?>">
...
<body>
                        ...
                        <div class="row no-gutters align-items-center ">
                            <div class="col-lg-4 col-md-5">
                                <div class="slider-product-image d-none d-md-block">
                                    <img src="<?=base_url('./assets/layout9/images/slider/1.jpg');?>" alt="Slider">
                ...
                <div class="single-slider">
                        <div class="slider-bg">
                            <div class="row no-gutters align-items-center">
                                <div class="col-lg-4 col-md-5">
                                    <div class="slider-product-image d-none d-md-block">
                                        <img src="<?=base_url('./assets/layout9/images/slider/2.jpg');?>" alt="Slider">
                                        <div class="slider-discount-tag">
                                            <p>-20% <br> OFF</p>
                                        </div>
                                    </div> <!-- slider product image -->
                ...
                <div class="single-slider">
                        <div class="slider-bg">
                            <div class="row no-gutters align-items-center">
                                <div class="col-lg-4 col-md-5">
                                    <div class="slider-product-image d-none d-md-block">
                                        <img src="<?=base_url('./assets/layout9/images/slider/3.jpg');?>" alt="Slider">
                                        <div class="slider-discount-tag">
                                            <p>FREE<br> QUOTE</p>
                                        </div>
                                    </div> <!-- slider product image -->
                ...
                <div class="col-lg-6">
                    <div class="single-discount-product mt-30">
                        <div class="product-image">
                            <img src="<?=base_url('./assets/layout9/images/discount-product/product-1.jpg');?>" alt="Product">
                        </div> <!-- product image -->
                            ...
                            <div class="product-items mt-30">
                                <div class="row product-items-active">
                                    <div class="col-md-4">
                                        <div class="single-product-items">
                                            <div class="product-item-image">
                                                <a href="#"><img src="<?=base_url('./assets/layout9/images/product/p-1.jpg');?>" alt="Product"></a>
                                    ...
                                    <div class="col-md-4">
                                        <div class="single-product-items">
                                            <div class="product-item-image">
                                                <a href="#"><img src="<?=base_url('./assets/layout9/images/product/p-2.jpg');?>" alt="Product"></a>
                                                <div class="product-discount-tag">
                                                    <p>-20%</p>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="single-product-items">
                                            <div class="product-item-image">
                                                <a href="#"><img src="<?=base_url('./assets/layout9/images/product/p-3.jpg');?>" alt="Product"></a>
                                                <div class="product-discount-tag">
                                                    <p>-10%</p>
                                                </div>
                                            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="services-left mt-45">
                        <div class="services">
                            <img src="<?=base_url('./assets/layout9/images/services/services.jpg');?>" alt="">
                ...
                <div class="col-lg-12">
                    <div class="showcase-active mt-65">
                        <div class="single-showcase">
                            <img src="<?=base_url('./assets/layout9/images/showcase/t-1.jpg');?>" alt="Testimonial">
                            <a href="#" class="main-btn">Full Preview</a>
                        </div> <!-- single showcase -->
                        <div class="single-showcase">
                            <img src="<?=base_url('./assets/layout9/images/showcase/t-2.jpg');?>" alt="Testimonial">
                            <a href="#" class="main-btn">Full Preview</a>
                        </div> <!-- single showcase -->
                    </div> <!-- showcase active -->
                </div>
    ...
    <section id="testimonial" class="testimonial-area pt-200">
        <div class="testimonial-bg bg_cover" style="background-image: url(./assets/layout9/images/testimonial/ts-bg.jpg)"></div>
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog mt-30">
                        <div class="blog-image">
                            <img src="<?=base_url('./assets/layout9/images/blog/b-1.jpg');?>" alt="Blog">
                        </div>
                        <div class="blog-content">
                            ...
                            <div class="meta d-flex justify-content-between align-items-center">
                                <div class="meta-admin d-flex align-items-center">
                                    <div class="image">
                                        <a href="#"><img src="<?=base_url('./assets/layout9/images/blog/admin.jpg');?>" alt="Admin"></a>
                                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog mt-30">
                        <div class="blog-image">
                            <img src="<?=base_url('./assets/layout9/images/blog/b-2.jpg');?>" alt="Blog">
                        </div>
                        <div class="blog-content">
                            <div class="content">
                                <h4 class="title"><a href="#">Rowan an orangutan known  & loved</a></h4>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="copyright text-center">
                            <p>&copy; Copyright 2021. All Rights Reserved</a></p>
                        </div> <!-- copyright -->
                    </div>
                </div> <!-- row -->
    ...
    <!--====== jquery js ======-->
    <script src="<?=base_url('./assets/layout9/js/vendor/modernizr-3.6.0.min.js');?>"></script>
    <script src="<?=base_url('./assets/layout9/js/vendor/jquery-1.12.4.min.js');?>"></script>

    <!--====== Bootstrap js ======-->
    <script src="<?=base_url('./assets/layout9/js/bootstrap.min.js');?>"></script>
    
    
    <!--====== Slick js ======-->
    <script src="<?=base_url('./assets/layout9/js/slick.min.js');?>"></script>
    
    <!--====== Magnific Popup js ======-->
    <script src="<?=base_url('./assets/layout9/js/jquery.magnific-popup.min.js');?>"></script>

    
    <!--====== nav js ======-->
    <script src="<?=base_url('./assets/layout9/js/jquery.nav.js');?>"></script>
    
    <!--====== Nice Number js ======-->
    <script src="<?=base_url('./assets/layout9/js/jquery.nice-number.min.js');?>"></script>
    
    <!--====== Main js ======-->
    <script src="<?=base_url('./assets/layout9/js/main.js');?>"></script>
</body>
</html>
