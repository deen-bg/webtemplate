...
<html lang="en-US" dir="ltr">
  <head>
    ...
    -->
    <!-- Default stylesheets-->
    <link href="<?=base_url('./assets/layout8/lib/bootstrap/dist/css/bootstrap.min.css');?>" rel="stylesheet">
    <!-- Template specific stylesheets-->
    <link href="https://fonts.googleapis.com/css?family=Roboto+Condensed:400,700" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Volkhov:400i" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700,800" rel="stylesheet">
    <link href="<?=base_url('./assets/layout8/lib/animate.css/animate.css');?>" rel="stylesheet">
    <link href="<?=base_url('./assets/layout8/lib/components-font-awesome/css/font-awesome.min.css');?>" rel="stylesheet">
    <link href="<?=base_url('./assets/layout8/lib/et-line-font/et-line-font.css');?>" rel="stylesheet">
    <link href="<?=base_url('./assets/layout8/lib/flexslider/flexslider.css');?>" rel="stylesheet">
    <link href="<?=base_url('./assets/layout8/lib/owl.carousel/dist/assets/owl.carousel.min.css');?>" rel="stylesheet">
    <link href="<?=base_url('./assets/layout8/lib/owl.carousel/dist/assets/owl.theme.default.min.css');?>" rel="stylesheet">
    <link href="<?=base_url('./assets/layout8/lib/magnific-popup/dist/magnific-popup.css');?>" rel="stylesheet">
    <link href="<?=base_url('./assets/layout8/lib/simple-text-rotator/simpletextrotator.css');?>" rel="stylesheet">
    <!-- Main stylesheet and color file-->
    <link href="<?=base_url('./assets/layout8/css/style.css');?>" rel="stylesheet">
    <link id="color-scheme" href="<?=base_url('./assets/layout8/css/colors/default.css');?>" rel="stylesheet">
  </head>
  <body data-spy="scroll" data-target=".onpage-navigation" data-offset="60">
      ...
      <nav class="navbar navbar-custom navbar-transparent navbar-fixed-top one-page" role="navigation">
        <div class="container">
          <div class="navbar-header">
            <button class="navbar-toggle" type="button" data-toggle="collapse" data-target="#custom-collapse"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button><a class="navbar-brand" href="#">LOGO</a>
          </div>
      ...
      <section class="home-section home-full-height bg-dark bg-gradient" id="home" data-background="assets/images/section-10.jpg">
        <div class="titan-caption">
          <div class="caption-content">
            ...
            <div class="font-alt mb-40 titan-title-size-4">LAOUT 8</div><a class="section-scroll btn btn-border-w btn-round" href="#">Learn More</a>
          </div>
        </div>
      </section>
      <div class="main">
        ...
        <section class="module pb-0" id="works">
          ...
          <ul class="works-grid works-grid-gut works-grid-3 works-hover-w" id="works-grid">
            <li class="work-item illustration webdesign"><a href="portfolio-single-1.html">
                <div class="work-image"><img src="<?=base_url('./assets/layout8/images/work-1.jpg');?>" alt="Portfolio Item"/></div>
                <div class="work-caption font-alt">
                  <h3 class="work-title">Corporate Identity</h3>
                  <div class="work-descr">Illustration</div>
                </div></a></li>
            <li class="work-item marketing photography"><a href="portfolio-single-1.html">
                <div class="work-image"><img src="<?=base_url('./assets/layout8/images/work-2.jpg');?>" alt="Portfolio Item"/></div>
                <div class="work-caption font-alt">
                  <h3 class="work-title">Bag MockUp</h3>
                  <div class="work-descr">Marketing</div>
                </div></a></li>
            <li class="work-item illustration photography"><a href="portfolio-single-1.html">
                <div class="work-image"><img src="<?=base_url('./assets/layout8/images/work-3.jpg');?>" alt="Portfolio Item"/></div>
                <div class="work-caption font-alt">
                  <h3 class="work-title">Disk Cover</h3>
                  <div class="work-descr">Illustration</div>
                </div></a></li>
            <li class="work-item marketing photography"><a href="portfolio-single-1.html">
                <div class="work-image"><img src="<?=base_url('./assets/layout8/images/work-4.jpg');?>" alt="Portfolio Item"/></div>
                <div class="work-caption font-alt">
                  <h3 class="work-title">Business Card</h3>
                  <div class="work-descr">Photography</div>
                </div></a></li>
            <li class="work-item illustration webdesign"><a href="portfolio-single-1.html">
                <div class="work-image"><img src="<?=base_url('./assets/layout8/images/work-5.jpg');?>" alt="Portfolio Item"/></div>
                <div class="work-caption font-alt">
                  <h3 class="work-title">Business Card</h3>
                  <div class="work-descr">Webdesign</div>
                </div></a></li>
            <li class="work-item marketing webdesign"><a href="portfolio-single-1.html">
                <div class="work-image"><img src="<?=base_url('./assets/layout8/images/work-6.jpg');?>" alt="Portfolio Item"/></div>
                <div class="work-caption font-alt">
          ...
          <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-lg-6 hidden-xs hidden-sm">
                <div class="alt-services-image align-center"><img src="<?=base_url('./assets/layout8/images/promo.png');?>" alt="Feature Image"></div>
              </div>
              <div class="col-sm-6 col-md-3 col-lg-3">
                <div class="alt-features-item">
          ...
          <div class="container">
            ...
            <div class="row">
              <div class="mb-sm-20 wow fadeInUp col-sm-6 col-md-3" onclick="wow fadeInUp">
                <div class="team-item">
                  <div class="team-image"><img src="<?=base_url('./assets/layout8/images/team-1.jpg');?>" alt="Member Photo"/>
              ...
              <div class="mb-sm-20 wow fadeInUp col-sm-6 col-md-3" onclick="wow fadeInUp">
                <div class="team-item">
                  <div class="team-image"><img src="<?=base_url('./assets/layout8/images/team-2.jpg');?>" alt="Member Photo"/>
                    <div class="team-detail">
              ...
              <div class="mb-sm-20 wow fadeInUp col-sm-6 col-md-3" onclick="wow fadeInUp">
                <div class="team-item">
                  <div class="team-image"><img src="<?=base_url('./assets/layout8/images/team-3.jpg');?>" alt="Member Photo"/>
                    <div class="team-detail">
              ...
              <div class="mb-sm-20 wow fadeInUp col-sm-6 col-md-3" onclick="wow fadeInUp">
                <div class="team-item">
                  <div class="team-image"><img src="<?=base_url('./assets/layout8/images/team-4.jpg');?>" alt="Member Photo"/>
                    <div class="team-detail">
            ...
            <div class="row multi-columns-row">
              ...
              <div class="col-sm-6 col-md-3 col-lg-3">
                <div class="price-table font-alt">
                  <h4>Basic</h4>
                  <div class="borderline"></div>
                  <p class="price"><span>THB.</span>29
                  </p>
                  <ul class="price-details">
                    <li>Free Support</li>
                    <li>15 Demos Included</li>
              ...
              <div class="col-sm-6 col-md-3 col-lg-3">
                <div class="price-table font-alt best">
                  ...
                  <div class="borderline"></div>
                  <p class="price"><span>THB.</span>64
                  </p>
                  <ul class="price-details">
                    <li>Free Support</li>
                    <li>15 Demos Included</li>
              ...
              <div class="col-sm-6 col-md-3 col-lg-3">
                <div class="price-table font-alt">
                  <h4>Ultimate</h4>
                  <div class="borderline"></div>
                  <p class="price"><span>THB.</span>119
                  </p>
                  <ul class="price-details">
                    <li>Free Support</li>
                    <li>15 Demos Included</li>
            ...
            <div class="row multi-columns-row post-columns">
              <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="post mb-20">
                  <div class="post-thumbnail"><a href="#"><img src="<?=base_url('./assets/layout8/images/post-1.jpg');?>" alt="Blog-post Thumbnail"/></a></div>
              ...
              <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="post mb-20">
                  <div class="post-thumbnail"><a href="#"><img src="<?=base_url('./assets/layout8/images/post-2.jpg');?>" alt="Blog-post Thumbnail"/></a></div>
                  <div class="post-header font-alt">
              ...
              <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="post mb-20">
                  <div class="post-thumbnail"><a href="#"><img src="<?=base_url('./assets/layout8/images/post-3.jpg');?>" alt="Blog-post Thumbnail"/></a></div>
                  <div class="post-header font-alt">
            ...
            <div class="row">
              <div class="col-sm-3">
                <div class="widget">
                  ...
                  <p>Email:<a href="#">company@example.com</a></p>
                </div>
              </div>
              <div class="col-sm-3">
                <div class="widget">
              ...
              <div class="col-sm-3">
                <div class="widget">
                  ...
                  <ul class="widget-posts">
                    <li class="clearfix">
                      <div class="widget-posts-image"><a href="#"><img src="<?=base_url('./assets/layout8/images/rp-1.jpg');?>" alt="Post Thumbnail"/></a></div>
                    ...
                    <li class="clearfix">
                      <div class="widget-posts-image"><a href="#"><img src="<?=base_url('./assets/layout8/images/rp-2.jpg');?>" alt="Post Thumbnail"/></a></div>
                      <div class="widget-posts-body">
        ...
        <footer class="footer bg-dark">
          <div class="container">
            <div class="row">
              <div class="col-sm-6">
                <p class="copyright font-alt">&copy; 2021&nbsp;, All Rights Reserved</p>
              </div>
              <div class="col-sm-6">
                <div class="footer-social-links"><a href="#"><i class="fa fa-facebook"></i></a><a href="#"><i class="fa fa-twitter"></i></a>
                </div>
              </div>
            </div>
          </div>
    ...
    =============================================
    -->
    <script src="<?=base_url('./assets/layout8/lib/jquery/dist/jquery.js');?>"></script>
    <script src="<?=base_url('./assets/layout8/lib/bootstrap/dist/js/bootstrap.min.js');?>"></script>
    <script src="<?=base_url('./assets/layout8/lib/wow/dist/wow.js');?>"></script>
    <script src="<?=base_url('./assets/layout8/lib/jquery.mb.ytplayer/dist/jquery.mb.YTPlayer.js');?>"></script>
    <script src="<?=base_url('./assets/layout8/lib/isotope/dist/isotope.pkgd.js');?>"></script>
    <script src="<?=base_url('./assets/layout8/lib/imagesloaded/imagesloaded.pkgd.js');?>"></script>
    <script src="<?=base_url('./assets/layout8/lib/flexslider/jquery.flexslider.js');?>"></script>
    <script src="<?=base_url('./assets/layout8/lib/owl.carousel/dist/owl.carousel.min.js');?>"></script>
    <script src="<?=base_url('./assets/layout8/lib/smoothscroll.js');?>"></script>
    <script src="<?=base_url('./assets/layout8/lib/magnific-popup/dist/jquery.magnific-popup.js');?>"></script>
    <script src="<?=base_url('./assets/layout8/lib/simple-text-rotator/jquery.simple-text-rotator.min.js');?>"></script>
    <script async="" defer="" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDK2Axt8xiFYMBMDwwG1XzBQvEbYpzCvFU"></script>
    <script src="<?=base_url('./assets/layout8/js/plugins.js');?>"></script>
    <script src="<?=base_url('./assets/layout8/js/main.js');?>"></script>
  </body>
</html>